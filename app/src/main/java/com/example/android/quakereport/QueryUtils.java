...
/**
 * Created by Redwan Mahmud on 7/26/2018.
 */
    ...
    private static List<Earthquake> extractFeaturesFromJSON(String earthquakeJSON) {
        ...
        try {
            ...
            for(int i=0; i < earthquakeArray.length();i++){
                ...
                JSONObject props = currentEarthquake.getJSONObject("properties");
                ...
                String url_quake = props.getString("url");

                Earthquake earthquake = new Earthquake(magnitude,location,time,url_quake);
